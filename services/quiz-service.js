...
export async function createQuizService({ title, description, isRealTime, timeLimit, startAt, subjectId }) {
...
export const getAllFilter = async (quizName, subjectId, dateRange) => {
    ...
    return apiRequest(`/quizzes/filter?quizName=${quizName}&subjectId=${subjectId}&dateRange=${dateRange}&page=1&limit=10`, "GET");
}
